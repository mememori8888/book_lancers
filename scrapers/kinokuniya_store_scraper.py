...
class KinokuniyaStoreScraper(Scraper):
    def __init__(self):
        super().__init__("紀伊国屋書店 (店舗在庫)")
        self.base_url = "https://www.kinokuniya.co.jp/zaiko_info/{}/"

    def scrape(self, driver, isbn):
        """
        指定されたISBNで紀伊国屋書店(店舗在庫)をスクレイピングし、アクセス耐性をテストします。
