...
class SanseidoStoreScraper(Scraper):
    def __init__(self):
        super().__init__("三省堂書店 (店舗在庫)")
        self.base_url = "https://www.books-sanseido.co.jp/booksearch/booksearch_result.php?isbn={}"

    def scrape(self, driver, isbn):
        """
        指定されたISBNで三省堂書店(店舗在庫)をスクレイピングし、アクセス耐性をテストします。
