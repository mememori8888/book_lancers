...
class KinokuniyaEcScraper(Scraper):
    def __init__(self):
        super().__init__("紀伊国屋書店ウェブストア")
        self.base_url = "https://www.kinokuniya.co.jp/disp/CSfDispListPage_01.jsp?q={}"

    def scrape(self, driver, isbn):
        """
        指定されたISBNで紀伊国屋書店ウェブストアをスクレイピングし、アクセス耐性をテストします。
