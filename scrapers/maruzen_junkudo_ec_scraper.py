...
class MaruzenJunkudoEcScraper(Scraper):
    def __init__(self):
        super().__init__("丸善ジュンク堂書店 (Web)")
        self.base_url = "https://www.maruzenjunkudo.co.jp/search/?q={}"

    def scrape(self, driver, isbn):
        """
        指定されたISBNで丸善ジュンク堂書店(Web)をスクレイピングし、アクセス耐性をテストします。
