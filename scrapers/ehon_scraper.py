...
class EhonScraper(Scraper):
    def __init__(self):
        super().__init__("e-hon")
        self.base_url = "https://www.e-hon.ne.jp/bec/SA/List?&i_in_txt_key_word_c={}"

    def scrape(self, driver, isbn):
        """
        指定されたISBNでe-honをスクレイピングし、アクセス耐性をテストします。
